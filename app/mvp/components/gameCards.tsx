      ...
      <button>
        <div className="game-card bg-white shadow-md rounded-md overflow-hidden m-4">
          <div className="image-container">
            <Image
              src={imageUrl}
              alt={`Cover image of ${gameTitle}`}
              width={500}
              height={50}
            />
          </div>
          <div className="p-4">
            <h3 className="game-title font-bold text-gray-600 text-xl mb-2">
              {gameTitle}
            </h3>
            <p className="users text-gray-600">
              Items: {items.toLocaleString()}
            </p>
            <p className="return-rate text-gray-600">
...
const gamesData: GameData[] = [
  ...
  },
  {
    title: 'Mavia Land',
    imageUrl:
      'https://i.seadn.io/gcs/files/51d38eb7fbb6c62187b580aeaf108748.jpg?auto=format&dpr=1&w=3840',
    items: 10000,
    returnRate: '143 days',
    opensea: 'mavia-land'
  },
  ...
  },
  {
    title: 'Pixels-Farm',
    imageUrl:
      'https://i.seadn.io/gcs/files/9d16e8bd3da20ce7248b3338622b2041.png?auto=format&dpr=1&w=3840',
    items: 5000,
    returnRate: '238 days',
    opensea: 'pixels-farm'
  }
